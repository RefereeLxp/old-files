var REQUEST_URL = {
		PACKAGE_INFO: "http://webapi.br.baidu.com/v1/op_main_site_dl.jsonp"
	},
	utils = {
	...
	panes = {
		containerPane: {
			...
			_calcSize: function() {
				...
				t = Math.max(640, panes.elements.$win.width()), o = Math.max(450, panes.elements.$win.height()), s = Math.min(o / 1080, 1), e = 600 * s, i = o > 1080, n = (o - 1080) / 2, this.logoCssProps = {
					...
					marginLeft: .5 * -defaultCssProps.buttonDownload.width,
					top: this._calcElementTop(o, defaultCssProps.buttonDownload.top)
				}, panes.elements.$container.css({
					width: t,
					height: o
				}), panes.elements.$main.css("margin-top", h ? -(o - 160) : 0), panes.elements.$sub.height(o - 100), h || (panes.elements.$logo.css({
				...
				}), panes.elements.$download.css("top", this.downloadCssProps.top)), this._$textPoint.css({
					width: this.logoTextCssProps.width,
					height: this.logoTextCssProps.height,
					"margin-left": this.logoTextCssProps.marginLeft,
					top: this.logoTextCssProps.top
				...
				}), panes.browser.IE6 && panes.elements.$desc.find("h2 img").height(defaultCssProps.descTitle.height * s), Modernizr.csstransforms && (a = Modernizr.prefixed("transform"), this._$scales.css(a, "scale(" + s + ")")), l = (i ? n : 0) + (i ? 1080 : o) * (defaultCssProps.buttonDownload.top / 100) + defaultCssProps.packageInfo.marginTop * s + defaultCssProps.buttonDownload.height, panes.elements.$package.css("top", l), this._$subIcons.css({
					"padding-top": defaultCssProps.subItemIcon.paddingTop * s,
					"padding-bottom": defaultCssProps.subItemIcon.paddingBottom * s
				}), panes.elements.$boxes.css("font-size", 32 * s), this._calcLogosSize(s, o), this._clipAircraftBackground(t, o), this._clipWallpaper(t, o), this.respond(t, o)
			},
			_setPackageInfo: function() {
				$.ajax(REQUEST_URL.PACKAGE_INFO, {
					...
					success: function(t) {
						var o = t.data;
						panes.elements.$package.find(".package-version").text(o.version).end().find(".package-size").text(o.file_size).end().find(".package-release").text(o.update_time), panes.elements.$download.attr("href", o.dl_url).on("click", function() {
			...
			init: function() {
				var t = this;
				this._$textPoint = $("#logo-text-point"), this._$scales = $(".scale"), this._$subIcons = $(".sub-item-header"), this._$logoGroup1 = $(".logo-g1"), this._$logoGroup2 = $(".logo-g2"), this._$logoGroup3 = $(".logo-g3"), this._$logoGroup4 = $(".logo-g4"), this._$logoGroup5 = $(".logo-g5"), this._$logoGroup6 = $(".logo-g6"), this._$logoGroup7 = $(".logo-g7"), this.logoCssProps = null, this.logoTextCssProps = null, this.downloadCssProps = null, this._setPackageInfo(), this._calcSize(), panes.elements.$win.on("resize", function() {
					utils.throttle(t._calcSize, t)
				}), this._$logoGroup7.find(".logo-compass-pointer img").hide().eq(0).show(), Modernizr.cssanimations || (panes.elements.$boxes.find(".wallpaper[data-src]").each(function() {
					var t = $(this);
					t.attr("src", t.data("src"))
				}), this._$logoGroup3.find(".logo").toggle(), this._$logoGroup7.find(".logo-compass-pointer img").hide().eq(1).show()), $("body").on("dragstart", function(t) {
					t.preventDefault()
				}), $("#main").on("selectstart", function(t) {
					t.preventDefault()
				}), panes.elements.$win.on("orientationchange", function() {
					t._calcSize()
				})
			}
		},
		subPane: {
			...
			_toggleSubParts: function(t) {
				...
				return panes.subShowing = t, panes.elements.$logo.animate(s, this._duration, function() {
					o.resolve()
				}), panes.elements.$logoText.animate(e, this._duration), panes.elements.$download.animate(i, {
					duration: this._duration,
					start: function() {
						t && panes.elements.$container.removeClass("main-expanding"), t && panes.browser.ltIE9 && panes.elements.$win.height() <= 450 && panes.elements.$download.removeClass("button-download-mini")
					},
					done: function() {
						t || panes.elements.$container.addClass("main-expanding"), !t && panes.browser.ltIE9 && panes.elements.$win.height() <= 450 && panes.elements.$download.addClass("button-download-mini"), panes.containerPane.respond(panes.elements.$win.width(), panes.elements.$win.height())
					}
				}), o.promise()
			},
			_toggleSub: function(t) {
				var o = $.Deferred();
				return panes.elements.$main.toggleClass("main-collapsing", t), panes.elements.$main.animate({
					"margin-top": t ? -(panes.elements.$main.height() - 160) : 0
				}, this._duration, function() {
					o.resolve()
				}), panes.elements.$sub.animate({
					"margin-top": t ? -60 : 0
				}, this._duration), o.promise()
			},
			...
			_switchLogo: function(t) {
				var o = $.Deferred();
				return panes.elements.$boxes.find("li").eq(panes.slidePane.index).find(".logo-group").toggle(!t), panes.elements.$logo[t ? "fadeIn" : "fadeOut"](6 === panes.slidePane.index || panes.browser.ltIE9 ? 0 : 400, function() {
					o.resolve()
				}), o.promise()
			},
			show: function(t) {
				...
				$.when(this._switchLogo(!0)).then(function() {
					o._$activeSubitem = panes.elements.$sub.find("#" + t.subItemId).show(), o._$activeSubitem.find(".sub-item-wrapper").scrollTop(0).end().find(".button-down-shadow").hide(), o._toggleSub(!0).done(function() {
						o._posContent(t.subItemContentId)
					}), o._toggleSubParts(!0), o._toggleParts(!0)
				})
			},
			hide: function() {
				var t = this;
			...
			init: function() {
				var t, o = location.hash.substring(1),
					s = this;
				this._$hideToLeftElements = $("#top-left-bar"), this._$hideToRightElements = $("#top-right-bar, #slide-bar"), this._$activeSubitem = null, this._duration = 600, t = this._getActive(o), null !== t && this.show(t), panes.elements.$nav.on("click", "li", function(t) {
					var o, e = $(this).find("a").attr("href").substring(1);
					o = s._getActive(e), null !== o && (s.show(o), t.preventDefault())
				}), panes.elements.$sub.on("click", ".button-down", function(t) {
					s.hide(), t.preventDefault()
				})
			}
		},
		slidePane: {
			_balloonFlyAway: {
				...
				_redisplay: function(t, o) {
					var s = this;
					t ? this._$element.fadeOut(o, function() {
						s.start = !1, $(this).delay(t).toggleClass("anim-logo-balloons anim-logo-balloons-fly-away").fadeIn(2 * o)
					}) : (this.start = !1, this._$element.toggleClass("anim-logo-balloons anim-logo-balloons-fly-away"))
				},
				restore: function() {
					this._$element.hasClass("anim-logo-balloons-fly-away") && this._redisplay(), clearTimeout(this._timer), clearTimeout(this._startTimer)
				},
				init: function() {
					var t = this;
					this._$element = $(".logo-balloons"), panes.elements.$doc.on("mousemove click", function() {
						t._flyAway()
					})
				}
			},
			_maskSlide: {
				...
				_getNextIndex: function() {
					return this._index++, this._index > this._length - 1 && (this._index = 0, this._etLogosIndex++, this._balloonLogosIndex++, this._etLogosIndex > this._etLogosLength - 1 && (this._etLogosIndex = 0), this._balloonLogosIndex > this._balloonLogosLength - 1 && (this._balloonLogosIndex = 0)), this._getRealIndex()
				},
				_run: function() {
					...
					this._$logos.eq(t).hide("puff", {
						percent: 400
					}, 350), t = this._getNextIndex(), this._$logos.eq(t).show("scale", {
						easing: "easeOutQuint"
					}, this._speed / 2), this._timer = setTimeout(function() {
						o._run()
					}, this._duration)
				},
				start: function() {
					var t = this;
					this._index = 0, this._$logos.hide().first().show(), this._startTimer = setTimeout(function() {
						t._run()
					}, this._duration)
				},
				stop: function() {
					clearTimeout(this._startTimer), clearTimeout(this._timer)
				},
				init: function() {
					this._$logos = $(".logo-g2").find(".logo"), this._duration = 1e3, this._speed = 600, this._index = 0, this._etLogosIndex = 0, this._balloonLogosIndex = 0, this._etLogosLength = this._$logos.filter(".logo-et").length, this._balloonLogosLength = this._$logos.filter(".logo-balloon").length, this._length = this._$logos.length - (this._etLogosLength + this._balloonLogosLength) + 2
				}
			},
			...
			_run: function(t) {
				...
				}), this._$boxes.stop(!0, !0).hide("fade", this._duration).eq(t).show("fade", this._duration, function() {
					o._playAnimation(t)
			...
			auto: function() {
				var t = this,
					o = this.index;
				++o > this.length - 1 && (o = 0), this.running = !1, this._run(o), this._autoTimer = setTimeout(function() {
					t.auto()
				}, this._delay)
			},
			run: function(t) {
			...
			init: function() {
				var t = this;
				this._$nav = $("#slide-bar"), this._$boxes = panes.elements.$boxes.find("li").hide().first().show().end(), this._$desc = panes.elements.$desc.find("li").hide().first().show().end(), this._$anims = this._$boxes.find("[data-anim]"), this.index = 0, this.length = this._$boxes.length, this._duration = 1e3, this._delay = 5e3, this._maskSlide.init(), Modernizr.cssanimations && this._balloonFlyAway.init(), this._$nav.on("click", "li", function(o) {
					t.run($(this).index()), o.preventDefault()
				}), panes.elements.$main.on("mousewheel", function(o) {
					return panes.subShowing ? void 0 : (t[o.deltaY > 0 ? "prev" : "next"](), o.deltaY > 0 && t.index - 1 < 0 || o.deltaY < 0 && t.index + 1 > t.length - 1)
				}), panes.elements.$doc.on("keydown", function(o) {
					var s = utils.keyCode;
					switch (o.keyCode) {
						case s.DOWN:
						case s.RIGHT:
		...
		subItemPane: {
			notifyLight: function(t, o) {
				var s = this;
				t = t || 500, o = o || 2e3, this._$light.delay(t).fadeOut(o, function() {
					$(this).delay(t).fadeIn(o, function() {
						s.notifyLight(t, o)
					})
				})
			},
			...
			init: function() {
				var t = this;
				this._$light = $(".log-begin-icon-light"), panes.browser.ltIE9 || this.notifyLight(), $(".sub-item-wrapper").on("mousewheel", function(o) {
					var s, e = $(this),
						...
						r = a - n;
					if (!(n >= a)) return s = o.deltaY > 0 && Math.abs(l) - h <= 0 ? 0 : o.deltaY < 0 && Math.abs(l) + h > r ? -r : l + o.deltaY * h, e.scrollTop(e.scrollTop() - o.deltaY * h), e.siblings(".button-down").find(".button-down-shadow").toggle(e.scrollTop() > 0), o.deltaY > 0 && 0 === s || o.deltaY < 0 && Math.abs(s) === r
				})
			}
		},
		init: function() {
			this.elements = {}, this.elements.$win = $(window), this.elements.$doc = $(document), this.elements.$container = $("#container"), this.elements.$main = $("#main"), this.elements.$sub = $("#sub"), this.elements.$logo = $("#logo"), this.elements.$logoText = $("#logo-text"), this.elements.$desc = $("#desc"), this.elements.$boxes = $("#boxes"), this.elements.$download = $("#button-download"), this.elements.$nav = $("#nav"), this.elements.$package = $("#package-info"), this.browser = {}, this.browser.IE6 = $("html").hasClass("lt-ie7"), this.browser.ltIE9 = $("html").hasClass("lt-ie9"), this.subShowing = !1, $.each(this, function(t, o) {
