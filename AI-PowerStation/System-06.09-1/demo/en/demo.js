...
$(function () {
	...
	WebVideoCtrl.I_InitPlugin(1600, 900, {
		iWndowType: 1,
...
var camIP='';
switch(sessionStorage['goT']){
	case 1 : camIP=uip1; break;
	case 2 : camIP=uip2; break;
	case 3 : camIP=uip4; break;
	case 4 : camIP=uip4; break;
}
// login
function clickLogin() {
...
setTimeout(function(){clickLogin();},1000);

setTimeout(function(){clickStartRealPlay()},2000);
setTimeout(function(){clickOpenSound();clickGetAudioInfo();},2000);
