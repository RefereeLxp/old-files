...
function add_station(){
    ...
    if($.inArray('', arr)==-1){
        $.ajax({
            type: 'POST',
            url: ' http://202.119.65.27:9999/monitor/ass/station/createStation',
...
$('#example2 tbody').on('click','.station-del', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://202.119.65.27:9999/monitor/ass/station/destroyStation',
...
$('#correct').on('click','#stationChange', function () {
    ...
    if(RegEx_judgment==true){
        if($.inArray('', arr)==-1){
            $.ajax({
                type: 'POST',
                url: 'http://202.119.65.27:9999/monitor/ass/station/updateStation',
                data: {sessionId:sessionStorage['sessionid'],st_id: st_id_1, st_code:st_code,st_name:st_name,parent_id:parent_id},
                success: function(){
                    alert('已修改');
                    location.reload();
                    $("#example2").DataTable();
    ...
    if(RegEx_judgment==true){
        if($.inArray('', arr)==-1){
            ...
            $.ajax({
                type: 'POST',
                url: 'http://202.119.65.27:9999/monitor/ass/station/updateStation',
                data: {sessionId:sessionStorage['sessionid'],st_id: st_id_2, st_code:st_code,st_name:st_name,parent_id:parent_id},
                success: function(){
                    alert('已修改');
                    location.reload();
                    $("#example3").DataTable();
