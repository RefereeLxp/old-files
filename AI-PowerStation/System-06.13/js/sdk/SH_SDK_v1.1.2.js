...
//function SHost(LOCALIP, LOCALPORT, SERVERIP, SERVERPORT, DEVICEID, ACCESSKEY) {
  ...
  function HostSocket(host) {
    ...
    //var LOCAL_IP    = "192.168.1.13";
    //var LOCAL_PORT  = 9999;
    //var SERVER_IP   = "192.168.1.2";
    //var SERVER_PORT = 5000;
    var LOCAL_IP    = "112.124.2.81";
  ...
  HostDataRepository.prototype = {
    ...
    getScenesInfoById : function (id) {
      var tempScenes = null;
      var tempScenesArray = this.getAllScenesInfo();
      for (var x = 0; x < tempScenesArray.length; x++) {
        if (id == tempScenesArray[x].id) {
          tempScenes = tempScenesArray[x];
          break;
        }
      }
...
SHost.prototype = {
  ...
  asyncOperationSocketSwitchDevices: function (id, on) {
    if (typeof on === 'boolean') {
      ...
      var tempStr = this.getHostDeviceRequestOperation('ZIGBEE_KonkeSocket', this.getHostDeviceOperateAction(), 'switch');
      var tempData = JSON.parse(tempStr);
      if (tempData == null) {
