                  ...
                  <div class="station-box-line">
                    ...
                    $.each(list.stations, function(i, p){
                        if(p.parent_id==parent_id){
                            html2 += `
                                <span class="box-disable stations"  data-st_id="${p.st_id}"  title='${p.st_name}'>${p.st_name}</span>
                            `;
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(list){
                                                ...
                                                $.each(list.stations, function(i, p){
                                                    if(p.parent_id==parent_id){
                                                        html += `
                           <div data-st_id1=${p.st_id}><b class="img-disable"></b><span class="box-disable" title='${p.st_name}'>${p.st_name}</span></div>
                        `;
                                                    }
                                                });
